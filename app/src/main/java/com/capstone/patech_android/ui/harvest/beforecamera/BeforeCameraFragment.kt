...
import com.capstone.patech_android.databinding.FragmentHarvestBeforeCameraBinding
...
class BeforeCameraFragment : ViewModelFragment<FragmentHarvestBeforeCameraBinding, HarvestViewModel>(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        previewAdapter = BeforeCameraPreviewAdapter(viewModel)
    ...
    companion object {
        const val BEFORE_URI = "beforeUri"
    }
}